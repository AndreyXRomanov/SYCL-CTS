...
class accessor {
 public:
  ...
  using iterator =
      typename std::array<std::remove_const_t<DataT>, 1>::const_iterator;
  using const_iterator =
      typename std::array<std::remove_const_t<DataT>, 1>::const_iterator;
  using reverse_iterator = typename std::array<std::remove_const_t<DataT>,
                                               1>::const_reverse_iterator;
  using const_reverse_iterator = typename std::array<std::remove_const_t<DataT>,
                                                     1>::const_reverse_iterator;
  ...
  DataT &operator[](sycl::id<Dimensions> index) {
    std::remove_const_t<DataT> ret_val;
    return ret_val;
  }
  ...
  std::array<std::remove_const_t<DataT>, 1> arr;
};
...
class accessor<DataT, 0, AccessMode, AccessTarget, isPlaceholder> {
 public:
  ...
  using iterator = typename std::vector<std::remove_const_t<DataT>>::iterator;
  using const_iterator =
      typename std::vector<std::remove_const_t<DataT>>::const_iterator;
  using reverse_iterator =
      typename std::vector<std::remove_const_t<DataT>>::reverse_iterator;
  using const_reverse_iterator =
      typename std::vector<std::remove_const_t<DataT>>::const_reverse_iterator;
...
class host_accessor {
 public:
  ...
  template <sycl::access::decorated IsDecorated>
  using accessor_ptr = std::shared_ptr<std::remove_const_t<DataT>>;
  using iterator = typename std::array<std::remove_const_t<DataT>, 1>::const_iterator;
  using const_iterator = typename std::array<std::remove_const_t<DataT>, 1>::const_iterator;
  using reverse_iterator =
      typename std::array<std::remove_const_t<DataT>, 1>::const_reverse_iterator;
  using const_reverse_iterator =
      typename std::array<std::remove_const_t<DataT>, 1>::const_reverse_iterator;
  ...
  /* Available only when: (Dimensions > 0) */
  host_accessor(sycl::buffer<DataT, Dimensions> &bufferRef) {}

  /* Available only when: (Dimensions > 0) */
  template <typename TagT>
  host_accessor(sycl::buffer<DataT, Dimensions> &bufferRef, TagT tag) {}
...
template <typename DataT, sycl::access_mode AccessMode,
          access::placeholder isPlaceholder>
class host_accessor<DataT, 0, AccessMode, isPlaceholder> {
 public:
  using value_type = DataT;
  using reference = value_type &;
  using const_reference = DataT &;
  ...
  using iterator = typename std::vector<std::remove_const_t<DataT>>::iterator;
  using const_iterator = typename std::vector<std::remove_const_t<DataT>>::const_iterator;
  using reverse_iterator = typename std::vector<std::remove_const_t<DataT>>::reverse_iterator;
  using const_reverse_iterator =
      typename std::vector<std::remove_const_t<DataT>>::const_reverse_iterator;
  ...
  /* Available only when: (Dimensions == 0) */
  host_accessor(sycl::buffer<DataT, 1> &bufferRef) {}
