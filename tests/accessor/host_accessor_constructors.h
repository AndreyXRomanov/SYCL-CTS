...
void test_zero_dimension_buffer_constructor(const std::string& access_mode_name,
  ...
  SECTION(section_name) {
    auto get_acc_functor = [](sycl::buffer<DataT, 1> data_buf) -> auto {
      return sycl_stub::host_accessor<DataT, 0, AccessModeT>(data_buf);
    };
...
void test_common_buffer_constructors(const std::string& access_mode_name,
  ...
  SECTION(section_name) {
    auto get_acc_functor =
        [](sycl::buffer<DataT, DimensionT> data_buf) -> auto {
      return sycl_stub::host_accessor<DataT, DimensionT, AccessModeT>(data_buf);
    };
  ...
  SECTION(section_name) {
    auto get_acc_functor =
        [ r, offset ](sycl::buffer<DataT, DimensionT> data_buf) -> auto {
      return sycl_stub::host_accessor<DataT, DimensionT, AccessModeT>(
          data_buf, r, offset);
    };
    check_common_constructor<AccTypeT, DataT, DimensionT, AccessModeT>(
...
void test_common_buffer_constructors_tag_t_deduction(
  ...
  SECTION(section_name) {
    auto get_acc_functor =
        [ r, tagT ](sycl::buffer<DataT, DimensionT> data_buf) -> auto {
      return sycl_stub::host_accessor(data_buf, r, tagT);
    };
    check_common_constructor<AccTypeT, DataT, DimensionT, AccessModeT>(
        get_acc_functor);
  }
  ...
  SECTION(section_name) {
    auto get_acc_functor =
        [ r, offset, tagT ](sycl::buffer<DataT, DimensionT> data_buf) -> auto {
      return sycl_stub::host_accessor(data_buf, r, offset, tagT);
    };
    check_common_constructor<AccTypeT, DataT, DimensionT, AccessModeT>(
        get_acc_functor);
  }
